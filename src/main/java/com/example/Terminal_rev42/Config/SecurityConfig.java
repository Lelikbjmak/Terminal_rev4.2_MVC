...
//    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/","/Barclays", "/Barclays/reg", "/Barclays/client/add", "/Terminal/**", "/Barclays/client/checkUsername", "/Barclays/client/checkPassword", "/Barclays/bill/PercentageForFixed" ).permitAll()
