...
@Component
public class ResetPasswordEmailSendListener {

    @Autowired
    private JavaMailSender mailSender;

    private static final Logger logger = LoggerFactory.getLogger(ResetPasswordEmailSendListener.class);
    ...
    public void handleResetPasswordEvent(ResetPasswordEvent event){
        ...
        String htmlMsg = "<a href = 'http://localhost:8080/Barclays'><img class='logomenu1' alt='Barclays Logo' src='https://www.vectorlogo.zone/logos/barclays/barclays-ar21.png' style='width: 275px; height: 150px; margin-top: -45px; display:block;'></a>" +
                ...
                "    <a href=\""+resetUrl+"\" style=' display: block; height: 100%; border-radius: 40px; padding: 10px; border:none; padding:0; margin:0; font-family:\"helvetica\",\"arial\",sans-serif; font-weight:700; line-height:50px; letter-spacing:0.15px; font-size:14px; text-decoration:none; text-align:center; text-transform:uppercase; color:#ffffff'>Reset password</a>\n" +
                "</div>\n" +
                "\n" +
                "\n" +
